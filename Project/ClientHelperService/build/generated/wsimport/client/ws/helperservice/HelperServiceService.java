 ...
 * 
 */
@WebServiceClient(name = "HelperServiceService", targetNamespace = "urn://helperservice.ws", wsdlLocation = "http://localhost:8080/HelperService/HelperServiceService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            ...
            url = new URL(baseUrl, "http://localhost:8080/HelperService/HelperServiceService?wsdl");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'http://localhost:8080/HelperService/HelperServiceService?wsdl', retrying as a local file");
