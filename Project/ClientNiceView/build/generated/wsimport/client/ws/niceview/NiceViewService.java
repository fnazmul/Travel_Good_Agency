 ...
 * 
 */
@WebServiceClient(name = "NiceViewService", targetNamespace = "urn://niceview.ws", wsdlLocation = "http://localhost:8080/NiceView/NiceViewService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            ...
            url = new URL(baseUrl, "http://localhost:8080/NiceView/NiceViewService?wsdl");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'http://localhost:8080/NiceView/NiceViewService?wsdl', retrying as a local file");
